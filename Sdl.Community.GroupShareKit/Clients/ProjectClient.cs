...
namespace Sdl.Community.GroupShareKit.Clients
{
    ...
    public class ProjectClient : ApiClient, IProjectClient
    {
        ...
        /// <exception cref="ApiException">Thrown when a general API error occurs.</exception>
        /// <returns> List <see cref="AnalysisReports"/>s.</returns>
        public async Task<IReadOnlyList<AnalysisReports>> GetAnalysisReportsV3AsJson(string projectId, string languageCode = null, int? reportId = null)
        {
            Ensure.ArgumentNotNullOrEmptyString(projectId, "projectId");

            var reportResult = await ApiConnection.GetWithContent<IReadOnlyList<AnalysisReports>>(ApiUrls.AnalysisReportsV3(projectId, languageCode, reportId), "text/json");
